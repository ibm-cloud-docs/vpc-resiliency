...
| Streamline app recovery \n (Cold DR and Warm DR sites)       | Use Terraform to provision resources and deploy the app     | - Use Terraform to automate out the build or scale out of the DR site on demand.  \n - Monitor the health of the production site and trigger the automation script to build or scale out the DR site. |
